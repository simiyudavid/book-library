...
top_frame = Frame(height=70,width=1080,bg='skyblue')
...
def hotel_status():
    global b_frame
b_frame = Frame(height=400,width=1080,bg='gray91')
...
#-------------- Guests --------------------------------------------------------------------------------------------------------------------------
def staff():
    b_frame = Frame(height=400,width=1080,bg='white')
path = "hostel.jpg"
img = ImageTk.PhotoImage(Image.open(path))
label = Label(b_frame,image = img ,height=400,width=1080)
label.image=img
...
Label(smf1,fg='cyan4',bg='white',font='msserif 35').pack()
...
Label(smf2,fg='cyan4',bg='white',font='msserif 35').pack()
smf2 = Frame(b_frame,height=120,width=145,bg='white')
...
def payments():
    b_frame = Frame(height=400,width=1080,bg='gray89')
path = "hostel7.jpg"
img = ImageTk.PhotoImage(Image.open(path))
label = Label(b_frame,image = img ,height=400,width=1080)
label.image=img
...
def reserve():
    b_frame = Frame(height=420,width=1080,bg='gray89')
path = "hostel8.jpg"
img = ImageTk.PhotoImage(Image.open(path))
...
#---------------2nd top frame-----------------------------------------------------------------------------------------------------------------
         ...
         sl_frame = Frame(height=130,width=1080,bg='white')
...
#-------------------extra frame------------------------------------------------------------------------------------------------------------------
         redf = Frame(height=6,width=1080,bg='lightsteelblue3')
         redf.place(x=0,y=70)
         redf1 = Frame(height=40,width=1080,bg='lightsteelblue3')
